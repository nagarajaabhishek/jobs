...
# Resolve repo root: apps/cli/scripts/tools -> repo root
PROJECT_ROOT = os.path.abspath(os.path.join(os.path.dirname(__file__), "..", "..", "..", ".."))
if PROJECT_ROOT not in sys.path:
    sys.path.insert(0, PROJECT_ROOT)

PROFILES_DIR = os.environ.get("PROFILE_DIR") or os.path.join(PROJECT_ROOT, "data", "profiles")
OUTPUT_PATH = os.environ.get("DENSE_MATRIX_PATH") or os.path.join(PROJECT_ROOT, "data", "dense_master_matrix.json")
...
def build_dense_matrix():
    ...
    master_path = os.environ.get("MASTER_PROFILE_PATH") or os.path.join(PROFILES_DIR, "master_context.yaml")
